...
888 independent patients. On a deeper level, we are interested in whether the treatments are more effective after recurrence of colon cancer, and by how much relative to each other's hazard ratios. A five percent significance level ($0.05$) will be used to balance the risk
...
```{r}
summary(coxph(Surv(start,stop,status) ~ rx*strata(episode) + strata(node4) + extent + surg, data = colon_counting))
```
## Conclusion
...
*rx*: The hazard rate for patients who took the treatment with just Levamisole is only $6.68\%$ less hazardous than taking no treatment at all. Those who took Fluoracil in addition to Levamisole benefited with a hazard ratio of $0.5973$, $40.27\%$ less hazardous than no treatment at all. It should also be noted that the confidence interval for only the Levamisole treatment has a 95% confidence interval of $(0.7472, 1.151)$, which includes the baseline of $1$, so it doesn't significantly decrease the hazard rate of colon cancer. However, the Levamisole + Fluoracil treatment has a 95% confidence interval of $(0.4707, 0.7508)$, which doesn't include the baseline of $1$, so it does significantly decrease the hazard rate of colon cancer.
...
The effect of just Levamisole on the hazard rate after recurrence of colon cancer has a hazard ratio of $1.2446$ compared to Levamisole on the hazard rate before a recurrence of colon cancer. Surprisingly, the effect of both Levamisole and Fluoracil after recurrence of colon cancer has a hazard ratio of $2.0885$ compared to both drugs on the hazard rate before a recurrence of colon cancer.

In either case, both treatments are much less effective after a recurrence of colon cancer.


## Decide what you want to do with the paragraph below
